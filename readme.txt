...
O arquivo config.txt deve ser modificado para conter as seguintes informações de cada maquina:
IP de envio.
IP da maquina.
Porta de recebimento.
Porta de envio.
Quando o programa inicia, ele pergunta qual o numero da maquina. Deve ser respondido um numero de 1 a 4,
